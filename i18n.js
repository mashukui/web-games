...
(function (global) {
  ...
  var S = {
    ...
    en: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 — three in a row against a computer that never loses. Think you can beat it? Play here: {url}',
      ...
      'connectFour.share': 'I played Connect Four 🔴 against the computer. Can you beat it? Play here: {url}',
    ...
    zh: {
      ...
      'ticTacToe.share': '我在玩《井字棋》🎯 「无敌」难度你敢来吗？来玩：{url}',
      ...
      'connectFour.share': '我在《四子棋》🔴 跟电脑对局，你能赢它吗？来玩：{url}',
    ...
    es: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 — tres en raya contra una IA que nunca pierde. ¿Te atreves? Juega aquí: {url}',
      ...
      'connectFour.share': 'He jugado a Connect Four 🔴 contra la máquina. ¿Puedes ganarle? Juega aquí: {url}',
    ...
    pt: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 — três em linha contra uma IA que não perde. Você encara? Jogue aqui: {url}',
      ...
      'connectFour.share': 'Joguei Connect Four 🔴 contra o computador. Consegue vencê-lo? Jogue aqui: {url}',
    ...
    fr: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 — trois pions contre une IA imbattable. Tu tentes ta chance ? Joue ici : {url}',
      ...
      'connectFour.share': 'J\'ai joué à Connect Four 🔴 contre l\'ordinateur. Tu peux le battre ? Joue ici : {url}',
    ...
    de: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 — drei in einer Reihe gegen eine unbesiegbare KI. Traust du dich? Hier spielen: {url}',
      ...
      'connectFour.share': 'Ich habe Connect Four 🔴 gegen den Computer gespielt. Schaffst du es, ihn zu besiegen? Hier spielen: {url}',
    ...
    ja: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 「無敵」AI に挑戦。勝てる？プレイはこちら：{url}',
      ...
      'connectFour.share': 'Connect Four 🔴 でコンピュータと対戦。勝てる？プレイはこちら：{url}',
    ...
    ko: {
      ...
      'ticTacToe.share': 'Tic Tac Toe 🎯 무적 AI에 도전했습니다. 이길 수 있나요? 여기서 플레이: {url}',
      ...
      'connectFour.share': 'Connect Four 🔴 컴퓨터 대전을 플레이했습니다. 이길 수 있나요? 여기서 플레이: {url}',
